...
PRODUCT_COPY_FILES := \
    vendor/qcom/sargo/proprietary/dnd.descriptor:system/etc/firmware/dnd.descriptor:qcom \
    vendor/qcom/sargo/proprietary/dnd.sound_model:system/etc/firmware/dnd.sound_model:qcom \
    vendor/qcom/sargo/proprietary/music_detector.descriptor:system/etc/firmware/music_detector.descriptor:qcom \
    vendor/qcom/sargo/proprietary/music_detector.sound_model:system/etc/firmware/music_detector.sound_model:qcom \
    vendor/qcom/sargo/proprietary/init-persist.rc:system/etc/init/init-persist.rc:qcom \
    vendor/qcom/sargo/proprietary/cneapiclient.xml:system/etc/permissions/cneapiclient.xml:qcom \
    vendor/qcom/sargo/proprietary/com.qualcomm.qti.imscmservice.xml:system/etc/permissions/com.qualcomm.qti.imscmservice.xml:qcom \
    ...
    vendor/qcom/sargo/proprietary/embmslibrary.jar:system/framework/embmslibrary.jar:qcom \
    ...
    vendor/qcom/sargo/proprietary/vendor.qti.hardware.data.latency-V1.0-java.jar:system/framework/vendor.qti.hardware.data.latency-V1.0-java.jar:qcom \
    ...
    vendor/qcom/sargo/proprietary/lib64/libqcbor.so:system/lib64/libqcbor.so:qcom \
    ...
    vendor/qcom/sargo/proprietary/lib64/libseccam.so:system/lib64/libseccam.so:qcom \
    vendor/qcom/sargo/proprietary/lib64/libsecureuisvc_jni.so:system/lib64/libsecureuisvc_jni.so:qcom \
    vendor/qcom/sargo/proprietary/lib64/libSeemplog.so:system/lib64/libSeemplog.so:qcom \
    vendor/qcom/sargo/proprietary/lib64/libsensorslog.so:system/lib64/libsensorslog.so:qcom \
    vendor/qcom/sargo/proprietary/lib64/libsmcinvokecred.so:system/lib64/libsmcinvokecred.so:qcom \
    vendor/qcom/sargo/proprietary/lib64/libsns_low_lat_stream_stub.so:system/lib64/libsns_low_lat_stream_stub.so:qcom \
    vendor/qcom/sargo/proprietary/lib64/libtzcom.so:system/lib64/libtzcom.so:qcom \
    ...
    vendor/qcom/sargo/proprietary/libqcbor.so:system/lib/libqcbor.so:qcom \
    ...
    vendor/qcom/sargo/proprietary/libseccam.so:system/lib/libseccam.so:qcom \
    vendor/qcom/sargo/proprietary/libsecureuisvc_jni.so:system/lib/libsecureuisvc_jni.so:qcom \
    vendor/qcom/sargo/proprietary/libSeemplog.so:system/lib/libSeemplog.so:qcom \
    vendor/qcom/sargo/proprietary/libsensorslog.so:system/lib/libsensorslog.so:qcom \
    vendor/qcom/sargo/proprietary/libsmcinvokecred.so:system/lib/libsmcinvokecred.so:qcom \
    vendor/qcom/sargo/proprietary/libsns_low_lat_stream_stub.so:system/lib/libsns_low_lat_stream_stub.so:qcom \
    vendor/qcom/sargo/proprietary/libtzcom.so:system/lib/libtzcom.so:qcom \
